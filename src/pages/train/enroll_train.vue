    ...
    <div class="_body">
      <div class="wrapper">
        <div class="row fx-white index-content" >
          ...
          <div class="col-xs-3" style="width: 75%;margin-left: -0.5rem;"><input    style="font-size: 14px;" v-model="userInfo.userName" readonly /></div>
        </div>
        <div class="row fx-white index-content">
          <div class="col-xs-4" style="margin-left: -2.5rem">手机号码</div>
          <div class="col-xs-3" style="width: 75%;margin-left: -1rem;"><input    style="font-size: 14px;" v-model="userInfo.mobilePhone"  readonly /></div>
        </div>
          <div class="row fx-white index-content" >
