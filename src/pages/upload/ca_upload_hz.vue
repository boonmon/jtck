  ...
  <div class="_upload_backdiv">
    ...
    <div class="_upload_div">
      ...
      <li class="_upload_li">组织机构代码证或工商营业执照副本
        <p >复印件1份，加盖公章 <span  style="color: red;margin-left: 1em" v-on:click="dataState('4')">{{dataState4}}</span></p>
      </li>
      <br><br>
      ...
      <el-button type="warning" icon="search" size="mini" :style="fileList_4.length>0?'margin-left:-0.3em;margin-bottom: 0.3em;':'margin-left: 2.6em;margin-bottom: 0.3em;'"  v-on:click="queryCaFile({'qrCodeId':qrCodeId,'type':4},fileList_4);">刷新</el-button>
